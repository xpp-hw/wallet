<template>
    <div id="anchor" ref="cont" class="cont">
        <div>
            <div class="top">“话费宝”活动参与协议aaaaa</div>
            <p>
                <span
            ...
            <p>
                <span class="main">2、钱包账户单账户余额不得超过2000元人民币。</span>
            </p>
            <p>
                <span class="main">3、</span>
                为了便于您参与“话费宝”活动，
                <span class="main"
                      style="font-weight: bold;color: red">需要您同意授权我们每日查询一次您在江苏移动掌厅APP上开立的钱包账户余额信息，以便于我们根据您的钱包账户日终（当日23:30—次日03:00）余额计算出赠送给您的话费金额（赠送话费金额按照您日终余额年化不低于5%测算）。</span>
            ...
            <p>
                <span
                    class="main"
                    style="color: red;font-weight: bold">4、确认参与“话费宝”活动后，从T+2日开始，您可以随时在江苏移动掌厅APP- 仪表盘【钱包】-【我的】-【话费宝】页面领取我们赠送给您的话费，领取成功后，话费将于3个工作日内发放至您钱包开户手机号对应的优惠账本，赠送的话费不可转账、提现、开票，不可用于话费购物或参加其他活动。</span>
            </p>
            <p>
                <span class="main" style="font-weight: bold;color: red">5、在领取话费当月，您无法办理手机号销户、过户、停机业务。</span>
            </p>
            <p>
                <span class="main">6、</span>
                如我们对本协议进行变更，我们将通过公告或客户端消息等方式予以通知，该变更自通知载明的生效时间开始生效。若您无法同意变更修改后的协议内容，您有权停止使用相关服务；双方协商一致的，也可另行变更相关服务和对应协议内容。
            </p>
