<template>
    <div class="box">
        <div>
            ...
            <!-- 立即领取 -->
            <div class="lingqu" id="B01" v-if="lingqu" @click="getRigntLost()" ref="lingqu"></div>
            <!-- 已领取 -->
        ...
        <div class="tankuang" v-if="tankuang">
            ...
            <div class="showRules" v-if="showRules">
                ...
                <div class="close" @click="(tankuang = false), (showRules = false)"></div>
            </div>
        </div>
    </div>
</template>
...
export default {
    data() {
        return {
            ...
            touchArr: [
                {
                    id: 'A01',
                    touchCode: 'WAP_T_GRATITUDE_01_A01'
                }, {
                    id: 'B01',
                    touchCode: 'WAP_T_GRATITUDE_01_B01'
                }, {
                    id: 'C01',
                    touchCode: 'WAP_T_GRATITUDE_01_C01'
                }, {
                    id: 'D01',
                    touchCode: 'WAP_T_GRATITUDE_01_D01'
                }
            ],
            accessSource: '00'
        };
    ...
    methods: {
        ...
        chongzhi() {
            this.lingqu_suc = false;
            this.tankuang = false;
            window.location.href = 'https://wap.js.10086.cn/vw/WSCZYL?ch=2400';
        },
        /* 查询是否为流失用户 */
        getLostuser() {
            this.lingqu = false;
        ...
        getRigntLost() {
            ...
            this.sorry = false;
            this.lingqu_suc = false;
            this.$refs.lingqu.className = 'pointerNone';
            // this.getLostuser();
            ...
            api.getRigntLost({
                ...
                .then((res) => {
                    this.$refs.lingqu.className = 'pointerAuto';
                    console.log('---', res);
                    if (res.rightSts == '01') {
                    /* 领取成功 */
                        this.tankuang = true;
...
.box {
    ...
    width: 750px;
    height: 1478px;
    background: url('../../assets/images/ganEn/bg.png') no-repeat;
    background-size: 100%;
    .rules {
        position: absolute;
        top: 345px;
        ...
        width: 61px;
        height: 148px;
        background: url('../../assets/images/ganEn/rules.png') no-repeat;
        background-size: 100%;
    }
    .lingqu {
        position: absolute;
        ...
        width: 391px;
        height: 99px;
        background: url('../../assets/images/ganEn/lingqu.png') no-repeat;
        background-size: 100%;
    }
    .yilingqu {
        position: absolute;
        ...
        width: 340px;
        height: 99px;
        background: url('../../assets/images/ganEn/yilingqu.png') no-repeat;
        background-size: 100%;
    }
    .bufuhe {
        position: absolute;
        ...
        width: 395px;
        height: 99px;
        background: url('../../assets/images/ganEn/bufuhe.png') no-repeat;
        background-size: 100%;
    }
}
.tankuang {
    ...
    .lingqu_suc {
        ...
        .suc_pic {
            width: 612px;
            height: 626px;
            background: url('../../assets/images/ganEn/lingqu_suc.png') no-repeat;
            background-size: 100%;
        }
        .chongzhi {
            position: absolute;
            ...
            width: 315px;
            height: 81px;
            background: url('../../assets/images/ganEn/chongzhi.png') no-repeat;
            background-size: 100%;
        }
        .go {
            position: absolute;
        ...
        .close {
            ...
            width: 54px;
            height: 54px;
            background: url('../../assets/images/ganEn/close.png') no-repeat;
            background-size: 100%;
        }
    }
    .sorry {
        ...
        .sorry_pic {
            width: 612px;
            height: 626px;
            background: url('../../assets/images/ganEn/sorry.png') no-repeat;
            background-size: 100%;
        }
        .toSee {
            position: absolute;
            ...
            width: 315px;
            height: 81px;
            background: url('../../assets/images/ganEn/toSee.png') no-repeat;
            background-size: 100%;
        }
        .close {
            position: absolute;
    ...
    .lingqu_fail {
        ...
        .fail_pic {
            width: 612px;
            height: 597px;
            background: url('../../assets/images/ganEn/lingqu_fail.png') no-repeat;
            background-size: 100%;
        }
        .haode {
            position: absolute;
            ...
            width: 272px;
            height: 82px;
            background: url('../../assets/images/ganEn/haode.png') no-repeat;
            background-size: 100%;
        }
        .close {
            position: absolute;
    ...
    .yicanyu {
        ...
        .canyu_pic {
            width: 607px;
            height: 641px;
            background: url('../../assets/images/ganEn/yicanyu.png') no-repeat;
            background-size: 100%;
        }
    ...
    .showRules {
        ...
        .rulesBg {
            width: 509px;
            height: 599px;
            background: url('../../assets/images/ganEn/rulesBg.png') no-repeat;
            background-size: 100%;
        }
        .rulesText {
            position: absolute;
